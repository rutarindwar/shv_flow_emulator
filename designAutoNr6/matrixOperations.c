...
/* Sorts a vector of double. Save the sorted list in a copy that is 
 * provided and save the indices in another array (provided as well)*/
    ...
    qsort(sortedLst, len, sizeof(double), compare);
